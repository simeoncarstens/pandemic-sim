...
class Person(object):
    def __init__(self, pos, vel, in_prob, out_prob, death_prob, infected=False, immune=False):
        self.pos = pos
        self.vel = vel
...
class Simulation(object):
    def __init__(self, room, persons, prob_dist, dt, cutoff, transmit_cutoff, k, time_to_heal):
        self.room = room
