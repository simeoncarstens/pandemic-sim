...
# two persons
base_prob = 0.00015
# reduce outgoing probability by 80%; meaning that a person is less likely to
...
# scenario
max_vel = 0.5
poss = room.get_random_position_set(n_persons)
persons = [Person(pos, #room.get_random_position(),
